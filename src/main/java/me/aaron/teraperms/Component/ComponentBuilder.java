...
public final class ComponentBuilder {
  ...
  private ComponentBuilder(BaseComponent[] parts) {
    ...
    for (i = (arrayOfBaseComponent = parts).length, b = 0; b < i; ) {
      BaseComponent baseComponent = arrayOfBaseComponent[b];
  ...
  public ComponentBuilder append(BaseComponent[] components, FormatRetention retention) {
    ...
    for (i = (arrayOfBaseComponent = components).length, b = 0; b < i; ) {
      BaseComponent component = arrayOfBaseComponent[b];
  ...
  public ComponentBuilder color(HexColor color) {
  ...
  public static interface Joiner {
    ComponentBuilder join(ComponentBuilder param1ComponentBuilder, FormatRetention param1FormatRetention);
  }
}
